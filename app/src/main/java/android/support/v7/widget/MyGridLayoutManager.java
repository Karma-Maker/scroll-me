...
public class MyGridLayoutManager extends LinearLayoutManager {
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == HORIZONTAL) {
            return new android.support.v7.widget.GridLayoutManager.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
        } else {
            return new android.support.v7.widget.GridLayoutManager.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    public RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        if (lp instanceof ViewGroup.MarginLayoutParams) {
            return new android.support.v7.widget.GridLayoutManager.LayoutParams((ViewGroup.MarginLayoutParams) lp);
        } else {
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
         ...
         * {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup#getSpanIndex(int, int)}.
         * <p>
